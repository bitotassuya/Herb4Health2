...
import com.example.asus.herbs4health.Common.Common;

import java.util.List;

import com.example.asus.herbs4health.LogoMain;
...
public class GridViewSuggestAdapter extends BaseAdapter {
    ...
    private LogoMain mainActivity;

    public GridViewSuggestAdapter(List<String> suggestSource, Context context, LogoMain mainActivity) {
